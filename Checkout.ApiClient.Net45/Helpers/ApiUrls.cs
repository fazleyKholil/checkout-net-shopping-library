...
public class ApiUrls
{
    ...
    private static string _shoppingApiUrl;
    ...
    public static string ShoppingItems
    {
        get
        {
            return _shoppingApiUrl ?? (_shoppingApiUrl = string.Concat(AppSettings.BaseApiUri, "/Shopping"));
        }
    }

    public static string ShoppingItemWithId
    {
        get
        {
